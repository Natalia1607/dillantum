        ...
        <div className="content__container">
          <Breadcrumb separator=">" className="breadcrumb mt12 mb24">
            ...
            <Breadcrumb.Item>
              ...
              {location.pathname === "/personal_account/ads" ? <>Ads</> : <></>}
            </Breadcrumb.Item>
          </Breadcrumb>
          <div className="user__icons flex jc-c gap mb24">
            <Link
              to={"/personal_account/searches"}
              className="flex column ai-c"
            >
              <GiArchiveResearch className="icon" size={26} />
              <span>My Searches</span>
            </Link>
            <Link
              to={"/personal_account/favorites"}
              className="flex column ai-c"
            >
          ...
          <Link to={"/createItem"} className="btn btn_ad m-auto mb24">
              Upload
          </Link>
        </div>
      </div>
